...
Partial Class LauncherSettings
    ...
    Private Sub InitializeComponent()
        ...
        Me.ToolTip1.SetToolTip(Me.TabPage_3, resources.GetString("TabPage_3.ToolTip"))
        '
        'GroupBox5
        '
        ...
        Me.ToolTip1.SetToolTip(Me.ComboBox_ManualBackupCopies, resources.GetString("ComboBox_ManualBackupCopies.ToolTip"))
        '
        'Label8
        '
        ...
        Me.ToolTip1.SetToolTip(Me.ComboBox_AutosaveBackupCopies, resources.GetString("ComboBox_AutosaveBackupCopies.ToolTip"))
        '
        'Label7
        '
        ...
        Me.ToolTip1.SetToolTip(Me.CheckBox_UseAutoBackups, resources.GetString("CheckBox_UseAutoBackups.ToolTip"))
        ...
        Me.ToolTip1.SetToolTip(Me.CheckBox_SqlBackup, resources.GetString("CheckBox_SqlBackup.ToolTip"))
